...
import { deleteCommentThunk, editCommentThunk } from "../../../app/module/commentSlice";
import { useDispatch } from "react-redux";
import styled from "styled-components";
import { fontExtraBold, fontSmall, fontMedium, fontBold } from "../../../shared/themes/textStyle";
...
const EditComment = (props) => {
  ...
  const onClickReplyButton = (event) => {
    ...
    if (reply === "" || (reply.comment === "" && localStorage.getItem("accessToken") !== null)) {
            ...
            <DefaultBox>
              ...
              <Buttons>
                {props.allComments.userKey === parseInt(getUserKey) ? (
                  <Button
                    onClick={(commentKey) => onClickDelete(String(props.allComments.commentKey))}
                  >
                    삭제
                  </Button>
                ) : null}
